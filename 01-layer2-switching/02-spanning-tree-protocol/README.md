...
The switch detected the unexpected BPDU and automatically placed the interface into an err-disabled state, preventing an unauthorized switch from affecting the spanning-tree topology.
...
The syslog output confirmed:

- BPDU Guard detected an unexpected BPDU.
- The affected access port was placed into an err-disabled state.
- The spanning-tree topology was protected from unauthorized devices.
